                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Ajout de l'utilisateur</h3>
                                <p class="mt-1 text-sm text-gray-600">
                                    Veuillez sasir les informations de l'utilisateur à ajouter
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <select id="country" name="country_id" required
                                                    ...
                                                    <?=\App\Utils\TemplateHelper::dropdown_contries($countries)?>
                                                </select>
                                            </div>
